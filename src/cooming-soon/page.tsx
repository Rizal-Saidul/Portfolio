...
export default function ComingSoon() {
  return (
    <div className="md:w-screen flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      {/* Animasi teks */}
      <motion.h1
